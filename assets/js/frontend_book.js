        ...
        $('#select-provider').on('change', function () {
            ...
            GlobalVariables.availableServices.forEach(function (service) {
                ...
                if(service.id_users == providerId){
                    ...
                    var targetMainColor = GlobalVariables.mainColor;    
                    ...
                    $('#serviceCard').append(`
                        <div class="service-card">
                            ...
                            <div class="command-buttons service-button">
                                <button type="button" data-service-id="${service.id}" class="button-next-service btn button-next service-next" data-step_index="1" style="background: ${targetMainColor}; border-color: ${targetMainColor};">
                                    選擇                                    
